...
Current work: biological networks, network control theory, discrete and ODE biological models

Previous work: galactic modeling and population statistics, mesospheric hydroxyl airglow physics, pseudo-Riemannian
...
# Relevant Skills
Programming ability in C++, Python, Octave, R, Maple, Sage
Expertise in network and network modeling packages StableMotifs, BooleanNet, PyBoolNet, networkx, igraph, statnet
Proficient with graph visualization software yEd, tikz, gephi
...
#### Google Scholar profile: https://scholar.google.com/citations?user=xUOh4q4AAAAJ&hl=en&oi=ao
